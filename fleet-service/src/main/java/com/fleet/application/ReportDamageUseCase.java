...
public class ReportDamageUseCase {

    private final IVehicleRepository vehicleRepository;
    private final IEventPublisher eventPublisher;

    public ReportDamageUseCase(IVehicleRepository vehicleRepository, IEventPublisher eventPublisher) {
        this.vehicleRepository = vehicleRepository;
        this.eventPublisher = eventPublisher;
    }

    public void handle(ReportDamageCommand command) {
        Vehicle vehicle = requireVehicle(command.vehicleId());
        vehicle.reportDamage(command.description(), command.severity());
